/** Javascript/PHP Spell Checker v1.5.2 https://github.com/LPology/Javascript-PHP-Spell-Checker Copyright 2012-2013 LPology, LLC Released under the MIT license */
...
function(){a._ignore(!0)});d.addEvent("spell-change"+this._uId,"click",function(){a._makeChange()});d.addEvent("spell-change-all"+this._uId,"click",function(){a._makeChange(!0)});d.addEvent("spell-close"+this._uId,"click",function(){a._closeChecker()});d.addEvent("spell-msg-close"+this._uId,"click",function(){a._closeChecker()});d.addEvent("spell-undo"+this._uId,"click",function(){a._canUndo&&a._undoChange()});d.addEvent(b,"click",function(){e("spelling-suggestions"+a._uId).selectedIndex=-1});d.addEvent(c,
"click",function(){e("spelling-suggestions"+a._uId).selectedIndex=-1});d.addEvent(b,"keyup",function(){var a=c.getElementsByTagName("span")[0];a&&a.firstChild&&(a.firstChild.nodeValue=this.value)});d.addEvent(c,"keyup",function(){var a=this.getElementsByTagName("span")[0];a&&a.firstChild&&(b.value=a.firstChild.nodeValue)})},destroy:function(){this._isOpen&&this._closeChecker();this._button.off&&this._button.off();this._button.className=this._button.className.replace(/(?:^|\s)spellcheck-trigger(?!\S)/,
...
this._textInput.value,this._canUndo=!1,this._isOpen=!0,this._undo=[],d.addEvent(f,"keyup",this._closeOnEsc),this._notifyMsg("a"),this._sendData())},_closeChecker:function(){this._isOpen&&(e("spell-msg"+this._uId).style.display="none",e("spell-modal"+this._uId).style.cssText="z-index:4999; display:none;",e("spell-overlay"+this._uId).style.display="none",e("spell-current"+this._uId).value="",e("spell-context"+this._uId).innerHTML="",e("spelling-suggestions"+this._uId).options.length=0,this._text=this._wordObject=
this._wordKeys=this._currentWord=this._wordMatches=this._matchOffset=this._undo=this._canUndo=this._isOpen=null,d.removeEvent(f,"keyup",this._closeOnEsc),this._settings.onClose.call(this,this._button,this._textInput.value))},_notifyMsg:function(a){var b,c=e("spell-msg-close-box"+this._uId);"a"==a?(b="Checking...",c.style.display="none"):c.style.display="block";"b"==a&&(b="We experienced an error and were unable to complete the spell check.");"c"==a&&(b="Spell check completed. No errors found.");"d"==
a&&(b="Spell check completed");e("spell-modal"+this._uId).style.zIndex=4999;e("spell-msg-text"+this._uId).innerHTML=b;e("spell-msg"+this._uId).style.display="block";"a"!=a&&e("spell-msg-close"+this._uId).focus()},_ignore:function(a){!0===a||1>=this._wordMatches||this._matchOffset===this._wordMatches?(this._wordKeys.splice(0,1),this._matchOffset=1,a=!1):(this._matchOffset++,a=!0);e("spell-undo"+this._uId).disabled=!0;for(this._canUndo=!1;0<this._undo.length;)this._undo.pop();0<this._wordKeys.length||
!0===a?this._reviewWord():this._notifyMsg("d")},_makeChange:function(a){var b=this._text,c=this._wordMatches,d=this._matchOffset,k=e("spelling-suggestions"+this._uId),p=this._getRegex(this._currentWord),f=k.selectedIndex,g=0,q;this._undo.unshift({text:b,word:this._currentWord,numMatches:this._wordMatches,matchOffset:this._matchOffset});e("spell-undo"+this._uId).disabled=!1;this._canUndo=!0;q=-1<f?k.options[f].text:e("spell-current"+this._uId).value;b=b.replace(p,function(b){g++;return!0===a||d===
g?q:b});!0===a||1>=c||d===c?(this._wordKeys.splice(0,1),this._matchOffset=1,c=!1):c=!0;this._textInput.value=this._text=b;0<this._wordKeys.length||!0===c?this._reviewWord():this._notifyMsg("d")},_undoChange:function(){var a=this._undo[0];this._textInput.value=this._text=a.text;e("spell-current"+this._uId).value=a.word;d.contains(this._wordKeys,a.word)||this._wordKeys.unshift(a.word);this._currentWord=a.word;this._wordMatches=a.numMatches;this._matchOffset=a.matchOffset;this._setSuggestionOptions();
this._setContextBox();this._undo.splice(0,1);1>this._undo.length&&(this._canUndo=!1,e("spell-undo"+this._uId).disabled=!0)},_setSuggestionOptions:function(){var a=e("spelling-suggestions"+this._uId),b=this._wordObject[this._currentWord],c=b.length,d;a.options.length=0;if(!(1>c)){for(d=0;d<c;d++)a.options[d]=new Option(b[d],b[d]);a.selectedIndex=0}},_setContextBox:function(){var a=this._currentWord,b=a.length,c=this._matchOffset,h=this._getRegex(a),k=this._text,f=k.length,g=e("spell-context"+this._uId),
m=0;k.replace(h,function(e,h){if(t.test(k.substr(h+b,1)))return e;m++;if(m===c){var n,l;n=h-20;l=h+b;n=0>n?k.substr(0,h):k.substr(n,20);l=l+50>f?k.substr(l):k.substr(l,50);n=n.replace(r,"").replace(v,"").replace(r,"");l=l.replace(s,"").replace(w,"").replace(s,"");g.innerHTML=d.encodeHTML(n)+'<span class="word-highlight">'+d.encodeHTML(a)+"</span>"+d.encodeHTML(l)}return e})},_reviewWord:function(){this._currentWord=this._wordKeys[0];e("spell-current"+this._uId).value=this._currentWord;this._wordMatches=
this._getTotalWordMatches();this._setSuggestionOptions();this._setContextBox()},_getTotalWordMatches:function(){var a=this._getRegex(this._currentWord),b=this._currentWord.length,c=0,d=this._text;this._text.replace(a,function(a,e){t.test(d.substr(e+b,1))||c++;return a});return c},_begin:function(a){a.success&&!0===a.success&&(a.errors&&!0===a.errors?(this._canUndo=!1,this._wordObject=a.words,this._wordKeys=d.objectKeys(this._wordObject),this._matchOffset=1,e("spell-msg"+this._uId).style.display="none",
e("spell-modal"+this._uId).style.zIndex=5001,this._reviewWord()):this._notifyMsg("c"))},_sendData:function(){var a=this,b=d.newXHR(),c,e;2>this._text.length?this._notifyMsg("c"):(c=encodeURIComponent(this._settings.name)+"=",c+=encodeURIComponent(this._text),d.isEmpty(this._settings.data)||(c=c+"&"+d.obj2string(this._settings.data)),e=function(){var c,f,g;try{if(e&&4===b.readyState&&(e=u,b.onreadystatechange=function(){},a._isOpen)){f=b.status;try{g=b.statusText}catch(m){g=""}a.log("Request completed. Status: "+
f+" "+g);200<=f&&300>f?(c=d.parseJSON(b.responseText),!1!==c?(a._settings.onOpen.call(a,a._button,a._text),a._begin(c)):(a.log("Error parsing server response"),a._notifyMsg("b")),b=c=null):a._notifyMsg("b")}}catch(q){a.log("Error: "+q.message),a._notifyMsg("b")}},b.onreadystatechange=e,b.open("POST",this._settings.action,!0),b.setRequestHeader("Accept","application/json, text/javascript, */*; q=0.01"),b.setRequestHeader("X-Requested-With","XMLHttpRequest"),b.setRequestHeader("Content-Type","application/x-www-form-urlencoded"),
a.log("Sending data..."),b.send(c))},_createHTML:function(){var a=f.createElement("div"),b=f.createElement("div"),c=f.createElement("div");f.body.appendChild(a);a.className="spell-check-overlay";a.id="spell-overlay"+this._uId;f.body.appendChild(b);b.className="spell-wrap";b.id="spell-modal"+this._uId;b.innerHTML='<div class="spell-header">Spell Check</div><div id="spelling-inner'+this._uId+'" class="spelling-inner"><div class="clearleft">Not found in dictionary:</div><div class="spell-nf"><input type="text" class="current" id="spell-current'+
...
this._uId+'"><button id="spell-msg-close'+this._uId+'">OK</button></div>'}};g.sc=d})(window,document);